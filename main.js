...
const calcualtorHistroy = document.querySelector('.history');
...
function addToHistory(){
    ...
    calcualtorHistroy.appendChild(newHistoryItem);
}

function clearHistory(){
    calcualtorHistroy.textContent='';
    if(calcualtorHistroy.textContent ===''){
...
equalsButon.addEventListener('click',showResult);
